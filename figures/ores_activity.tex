...
\begin{subfigure}[t]{\textwidth}
  \centering
  \includegraphics[width=.4\textwidth]{figures/ORES_request_activity_201804_week_vs_4hours}
...
\begin{subfigure}[t]{\columnwidth}
  \centering
  \includegraphics[width=.4\textwidth]{figures/ORES_precache_request_rate_201804}
